...
const Index = ({ repos, user }) => {
    return (
        <div className='container mx-auto bg-network'>
            ...
            <div>
                <h3 className='mx-2 md:mx-0 text-3xl md:text-4xl font-bold text-center text-orange uppercase mt-10'>Tech contributions</h3>
                <p className='text-center'>GitHub stats: 
                    <RiGitRepositoryLine className='inline-block'/> {user.public_repos} 
                    / <GoGist className='inline-block'/> {user.public_gists} 
                    / <FiUsers className='inline-block'/> {user.followers} </p>
                ...
                <div>
                    <p className='text-center my-8 py-4 border-t-4'>
                        You can find the source-code of this website:
                        <br/>
                        <a href=''>https://github.com/tuliofaria/tuliofaria.dev</a></p>
                </div>  
        </div>
    )
}
